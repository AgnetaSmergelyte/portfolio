                    ...
                    <div className="flex-1 project-text">
                        ...
                        <ul><h3 className="mb-1">Back-End:</h3>
                            <li>Server has been powered by Node.js, a runtime environment known for its non-blocking,
                                event-driven architecture, making it ideal for scalable applications.</li>
                            ...
                            <li>The platform supports real-time interactions using Socket.io for live game experience.</li>
                        </ul>
                    </div>
